...
export default function InteractiveGISMap({ events = [], onSelectEvent }) {
  ...
  // Render Distinct Colored Mappls Hazard Pointers
  useEffect(() => {
    ...
    // Add Mappls Marker for each event with its distinct color pointer
    filteredEvents.slice(0, 85).forEach((ev) => {
        ...
        <div style="font-family:'JetBrains Mono',monospace,sans-serif; min-width:270px; max-width:310px; padding:8px 4px; color:#0f172a; line-height:1.4;">
          ...
          ${isWaterlogged ? `
            <div style="background:#f0f9ff; border:1px solid #7dd3fc; border-radius:6px; padding:6px; margin:6px 0; font-size:11px;">
              ...
              <div style="font-size:9.5px; color:#64748b;">Bus Ground Clearance Limit: 35.0 cm</div>
            </div>
          ` : ''}
  ...
  return (
    <div className="hologram-card rounded-2xl p-4 mb-6 border border-cyan-500/20 relative">
        ...
        <div className="flex items-center space-x-2.5">
          ...
          <div>
            ...
            <div className="flex items-center space-x-2 text-[10px] font-mono text-slate-400 mt-0.5">
              ...
              <span>•</span>
              <span>Distinct Hazard Color Pointers Active</span>
            </div>
          </div>
        </div>
      ...
      <div className="relative w-full h-[470px] rounded-xl overflow-hidden border border-slate-800 bg-[#0a101d]">
        ...
        {/* Clean Map Legend: Hazard Pointer Colors */}
        <div className="absolute bottom-3 left-3 bg-slate-950/95 backdrop-blur-md px-3.5 py-2.5 rounded-xl border border-slate-700/60 text-[11px] font-mono text-slate-200 pointer-events-auto shadow-2xl z-10 space-y-1.5">
          <div className="text-[9.5px] uppercase font-bold text-slate-400 tracking-wider flex items-center justify-between">
            <span>Hazard Pointer Colors:</span>
          </div>
          <div className="flex flex-wrap items-center gap-3">
            <div className="flex items-center space-x-1.5">
              <span className="w-3 h-3 rounded-full bg-[#ef4444] border border-white/60 shadow-sm shadow-red-500/50"></span>
              <span className="text-white font-medium">Pothole (Shock)</span>
            </div>
            <div className="flex items-center space-x-1.5">
              <span className="w-3 h-3 rounded-full bg-[#f59e0b] border border-white/60 shadow-sm shadow-amber-500/50"></span>
              <span className="text-white font-medium">Near Miss</span>
            </div>
            <div className="flex items-center space-x-1.5">
              <span className="w-3 h-3 rounded-full bg-[#8b5cf6] border border-white/60 shadow-sm shadow-purple-500/50"></span>
              <span className="text-white font-medium">Divider</span>
            </div>
            <div className="flex items-center space-x-1.5">
              <span className="w-3 h-3 rounded-full bg-[#0284c7] border border-white/60 shadow-sm shadow-blue-500/50"></span>
